...
//crea un anime dado parametros y archivo dirigido
...
//obtiene el anime en base a un id y un archivo
const obtenerAnime = (id, archivo) => {
  try {
    ...
    if (anime) {
      ...
      throw new Error("no se pudo obtener anime");
    }
  } catch (error) {
    return error
  }
...
//elinina un anime en base a un id y un archivo
